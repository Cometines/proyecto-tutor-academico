...
| **Desarrollador 3** | Olga Lisseth García Gómez | `sources/capturas.c` | Implementación de la lógica de captura del numero de evaluaciones y estudiantes, con validaciones. |
| **Desarrollador 4** | Emmanuel Sánchez Trujillo | `sources/capturas.c` | Implementación de la captura de los datos de los estudiantes, calificaciones, validaciones de entrada y cálculo inicial de promedios. |
